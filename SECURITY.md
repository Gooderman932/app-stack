...
1. Use [GitHub Private Security Advisories](https://github.com/Gooderman932/app-stack/security/advisories/new), **or**
2. Email **security@poordudeholdings.com** with subject line `[SECURITY] app-stack — <summary>`.
